...
wstring Open = L"open \"Assets//BGM//Car1.mp3\"";
wstring Play = L"play \"Assets//BGM//Car1.mp3\"";
wstring Stop = L"stop \"Assets//BGM//Car1.mp3\"";
...
LRESULT CALLBACK WindowProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    switch(message)
    {
        ...
        case WM_KEYUP:
        {
            ...
            {
            case 0x57:
                mciSendString(Stop.c_str(), NULL, 0, 0);
                break;
            case 0x53:
                mciSendString(Stop.c_str(), NULL, 0, 0);
                break;
