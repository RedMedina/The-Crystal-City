...
private:
	...
	ID3D11ShaderResourceView* BumpMap2;
...
public:
	TerrenoRR(int ancho, int alto, ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext)
	{
		...
		CargaParametros(L"Assets/Images/distB.jpg", L"Assets/Images/Alturas.jpg", 100.0f);
	}
	...
	bool CargaParametros(WCHAR* diffuseTex, WCHAR* heightTex, float tile)
	{
		...
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, L"Assets/Images/grasstxt.jpg", 0, 0, &colorMap2, 0);
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, L"Assets/Images/bump1.png", 0, 0, &BumpMap, 0);
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, L"Assets/Images/bump2.png", 0, 0, &BumpMap2, 0);
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, L"Assets/Images/Blendmap.jpg", 0, 0, &blendMap, 0);
		...
		d3dResult = d3dDevice->CreateBuffer(&constDesc, 0, &DerrotaB);
	...
	void Draw(D3DXMATRIX vista, D3DXMATRIX proyeccion, float derrota)
	{
		...
		d3dContext->PSSetShaderResources(3, 1, &BumpMap);
		d3dContext->PSSetShaderResources(4, 1, &BumpMap2);
		...
		d3dContext->UpdateSubresource(DerrotaB, 0, 0, &derrota, 0, 0);
		...
		d3dContext->PSSetConstantBuffers(3, 1, &DerrotaB);
